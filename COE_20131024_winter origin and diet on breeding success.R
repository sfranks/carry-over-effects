...
### NOME
dotplot(INIT.JULIAN~Year,data=complete[complete$Site=="Nome",]) # 1 late outlier in 2008 (>150), 1 late outlier in 2009 (>159), 4 late outliers in 2010 (>157)
boxplot(INIT.JULIAN~Year, complete[complete$Site=="Nome",])
...
head(complete[complete$Site=="Nome"  & complete$Year=="2008",][rev(order(complete[complete$Site=="Nome" & complete$Year=="2008",]$INIT.JULIAN)),])	# dates are 154
firstnests<-Subset(complete,Band!="2008_228156938")
...
# 2010
complete[complete$Site=="Nome"  & complete$Year=="2010",][rev(order(complete[complete$Site=="Nome" & complete$Year=="2010",]$INIT.JULIAN)),]	# dates are 158-163
...
boxplot(INIT.JULIAN~Year,data=complete[complete$Site=="YKD",])


### Cape Krusenstern
dotplot(INIT.JULIAN~Year,data=complete[complete$Site=="Cape Krusenstern",]) # 0 outliers
boxplot(INIT.JULIAN~Year,data=complete[complete$Site=="Cape Krusenstern",])


# sample size by SITE and YEAR
n <- table(firstnests$Site, firstnests$Year)
n
